...
def get_bot_converter_response(message: Dict[str, str], bot_handler: Any) -> str:
    ...
    for convert_index in convert_indexes:
        ...
        if (convert_index + 3) < len(words):
            ...
            convertNum = float(number)
            number_res = copy.copy(convertNum)
