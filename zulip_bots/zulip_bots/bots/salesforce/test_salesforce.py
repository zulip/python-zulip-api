...
def mock_salesforce_auth(is_success: bool) -> Any:
    if is_success:
        ...
        with patch('simple_salesforce.api.Salesforce.__init__', side_effect=simple_salesforce.exceptions.SalesforceAuthenticationFailed(403, 'auth failed')) as mock_sf_init:
            mock_sf_init.return_value = None
            yield
